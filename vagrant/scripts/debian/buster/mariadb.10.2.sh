...
if [ -f $VAGRANT_APT_SOURCE ]; then
    ...
    sudo echo "deb [arch=amd64,i386,ppc64el] https://archive.mariadb.org/mariadb-10.2/repo/debian buster main" >> $MARIADB_APT_SOURCE_LIST
    sudo echo "deb-src https://archive.mariadb.org/mariadb-10.2/repo/debian buster main" >> $MARIADB_APT_SOURCE_LIST
