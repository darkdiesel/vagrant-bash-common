...
VAGRANT_APT_SOURCE=${VAGRANT__OS_CONFIGS_PATH}"/etc/apt/sources.list.d/mariadb.12.1.list"
...
if [ -f $VAGRANT_APT_SOURCE ]; then
    ...
    sudo echo "deb-src [signed-by=/usr/share/keyrings/mariadb-keyring.pgp] https://mirror.mariadb.org/repo/11.4/debian bullseye main" >> $MARIADB_APT_SOURCE_LIST
